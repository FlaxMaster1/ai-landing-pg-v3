...
export const frameworkRegistry: RegistryEntry[] = [
  ...
  register({ id: "CMP-responsive-image", name: "ResponsiveImage", category: "component", description: "Breakpoint-switched image presentation that serves a distinct mobile and desktop asset via the picture element.", requiredFields: ["mobileAsset", "desktopAsset"], accessibility: a11yMedia }),
  ...
  register({ id: "CMP-story-card", name: "StoryCard", category: "component", description: "Semantic Story entity presentation with a normalized topic hook for site-scoped content-category styling.", requiredFields: ["story"], variants: ["editorial", "compact", "feature", "media-led"], cmsNames: ["Story Tile"] }),
  ...
  register({ id: "CMP-person-card", name: "PersonCard", category: "component", description: "Semantic Person entity presentation.", requiredFields: ["person"], variants: ["card", "directory", "quote"], accessibility: a11yMedia, cmsNames: ["Bio Card"] }),
  ...
  register({ id: "PAT-story-collection", name: "StoryCollection", category: "pattern", description: "ContentFeed-backed Story collection.", requiredFields: ["id", "entityIds"], optionalFields: ["columns"], variants: ["grid", "list", "featured"], cmsNames: ["Top Stories", "Embed Posts", "Story feeds"] }),
  ...
  register({ id: "PAT-person-list", name: "PersonList", category: "pattern", description: "FacultyData-backed Person collection.", requiredFields: ["id", "entityIds"], variants: ["cards", "directory", "quote"], cmsNames: ["Faculty Index", "Staff Listing"] }),
